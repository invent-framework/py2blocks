...
Blockly.Blocks["Import"] = createPlusMinusBlock("import", "", "alias", ["alias"]);

Blockly.Blocks["ImportFrom"] = {
    init: function() {
    ...
    addItem: function() {
        ...
        input.connection.setCheck(["alias"]);
    },
    ...
    add_default_block: function(input) {
        const block = this.workspace.newBlock("alias");
        block.initSvg();
        block.render();
